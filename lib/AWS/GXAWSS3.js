            ...
            try {
                ...
                weak_this.s3.deleteObject(params, async function(err, data) {
                    if (err) {
                        ...
                        console.log(errMsg);
                        await new GXAdminAlert(weak_this.aws_region).send_mail(`${weak_this.constructor.name}::deleteVoiceMailItemFor:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
            ...
            try {
                ...
                weak_this.s3.headObject(params, async function(err, data) {
                    if (err) {
                        ...
                        console.log(errMsg);
                        await new GXAdminAlert(weak_this.aws_region).send_mail(`${this_fileName}::checkIfFileExist:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
                    resolve(true);
            ...
            try {
                ...
                weak_this.s3.getObject(params, async function(err, data) {
                    if (err) {
                        ...
                        await new GXAdminAlert(weak_this.aws_region).send_mail(`${this_fileName}::getFile:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
            ...
            try {
                ...
                weak_this.s3.deleteObject(params, async function(err, data) {
                    if (err) {
                        ...
                        console.log(errMsg);
                        await new GXAdminAlert(weak_this.aws_region).send_mail(`${weak_this.constructor.name}::deleteObject:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
                    resolve("done");
            ...
            try {
                ...
                weak_this.s3.putObject(params, async function(err, data) {
                    if (err) {
                        ...
                        console.error(errMsg);
                        await new GXAdminAlert(weak_this.aws_region).send_mail(`${weak_this.constructor.name}::putFileForPublicAuthenticatedRead:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
