...
const { GXErrors } = require('../../../../MyGix_FR_Resolvers/node_modules/gxhelperclasses/lib/GXErrors');
//const adminAlert = require('./../GXAdminMail/GXAdminAlert');
            ...
            try {
                ...
                weak_this.s3.copyObject(params, function(err, data) {
                    if (err) {
                        ...
                        console.log(errMsg);
                        new adminAlert().send_mail(`${weak_this.constructor.name}::copyVoiceMailGreetingItemFor:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
            ...
            try {
                ...
                weak_this.s3.deleteObject(params, function(err, data) {
                    if (err) {
                        ...
                        console.log(errMsg);
                        new adminAlert().send_mail(`${weak_this.constructor.name}::deleteVoiceMailItemFor:> Failed.`, errMsg);
                        reject(err);
                        return;
                    }
